   ...
   Price and Comments
        ...
        <div className="row x-gap-20 y-gap-20 pt-20">
          ...
          <h6 className="text-20 fw-500 mt-10 mb-22">Set Your Price
           ...
           <div className="mt-10 mb-40" style={{ gap: "10px" ,display:"flex"}}>
           <div className="col-md-4">
           <h2 className="text-16 fw-600">Regular Price</h2>
         ...
         <div className="col-md-4">
         <h2 className="text-16 fw-600">Commercial Price</h2>
         <div className="form-input mt-10">
           <input type="text" required />
       ...
       <div className="col-md-4">
       <h2 className="text-16 fw-600">Extended Commercial Price</h2>
       <div className="form-input mt-10">
         <input type="text" required />
