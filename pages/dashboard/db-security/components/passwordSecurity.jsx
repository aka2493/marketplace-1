const PasswordSecurity = () => {
    return (<div>
        ...
        <div className="row">
            <div className="col-4">
                <div className="single-field">
                    <input className="col-12 bg-white h-50 border" placeholder="Old Password" type="text" />
                </div>
            </div>
            <div className="col-4">
                <div className="single-field">
                    <input className="col-12 bg-white h-50 border" placeholder="New Password" type="text" />
                </div>
            </div>
            <div className="col-4">
                <div className="single-field">
                    <input className="col-12 bg-white h-50 border" placeholder="Confirm New Password" type="text" />
                </div>
            </div>
        </div>
        ...
        <div className="fw-500 text-18 d-flex items-center">Two-Factor authentication
            <div className="form-check form-switch ml-10">
